      ...
      <div class="col-md-3 sidebar">
        <div class="section-menu">
          <ul class="nav nav-list">
            ...
            <li class="active"><a href="contact.htm">Contact Us<small>How to get in touch</small><i class="icon-angle-right"></i></a></li>
          </ul>
        </div>
      </div>
      ...
      <div class="col-md-9">
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <p><abbr title="Address"><i class="icon-home"></i></abbr> Floor 4, Building B, Taoyuan Industrial Park, Huangpu East Development Zone, Guangzhou, China</p>
